        ...
        <div class="matches">
          ...
          >
            ...
            <div v-if="isRiposo(match)" class="riposo-row">
              <div class="team-badge" :style="{ background: getTeamColor(riposaTeam(match)) }">
                {{ getInitials(riposaTeam(match)) }}
              </div>
            ...
            <div v-else class="match-row">
              <div class="team home">
                <div class="team-badge" :style="{ background: getTeamColor(match.casa) }">
                  {{ getInitials(match.casa) }}
                </div>
              ...
              <div class="team away">
                ...
                <div class="team-badge" :style="{ background: getTeamColor(match.ospite) }">
                  {{ getInitials(match.ospite) }}
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="modal-box">
        ...
        <div class="modal-teams">
          <div class="modal-team">
            <div class="modal-badge" :style="{ background: getTeamColor(selectedMatch.casa) }">
              {{ getInitials(selectedMatch.casa) }}
            </div>
          ...
          <div class="modal-team">
            <div class="modal-badge" :style="{ background: getTeamColor(selectedMatch.ospite) }">
              {{ getInitials(selectedMatch.ospite) }}
            </div>
