  ...
  <div class="standings-wrapper">
    ...
    <div v-if="standings.length >= 3" class="podium">
      ...
      <div class="podium-item second">
        <div class="podium-badge" :style="getTeamLogo(standings[1].squadre) ? {} : { background: getTeamColor(standings[1].squadre) }">
          <img v-if="getTeamLogo(standings[1].squadre)" :src="getTeamLogo(standings[1].squadre)" class="badge-img" />
          <span v-else>{{ getInitials(standings[1].squadre) }}</span>
        </div>
        <div class="podium-name">{{ standings[1].squadre }}</div>
        <div class="podium-pts">{{ standings[1].punti }} <span>pts</span></div>
      ...
      <div class="podium-item first">
        ...
        <div class="podium-badge" :style="getTeamLogo(standings[0].squadre) ? {} : { background: getTeamColor(standings[0].squadre) }">
          <img v-if="getTeamLogo(standings[0].squadre)" :src="getTeamLogo(standings[0].squadre)" class="badge-img" />
          <span v-else>{{ getInitials(standings[0].squadre) }}</span>
        </div>
        <div class="podium-name">{{ standings[0].squadre }}</div>
        <div class="podium-pts">{{ standings[0].punti }} <span>pts</span></div>
      ...
      <div class="podium-item third">
        <div class="podium-badge" :style="getTeamLogo(standings[2].squadre) ? {} : { background: getTeamColor(standings[2].squadre) }">
          <img v-if="getTeamLogo(standings[2].squadre)" :src="getTeamLogo(standings[2].squadre)" class="badge-img" />
          <span v-else>{{ getInitials(standings[2].squadre) }}</span>
        </div>
        <div class="podium-name">{{ standings[2].squadre }}</div>
        <div class="podium-pts">{{ standings[2].punti }} <span>pts</span></div>
          ...
          >
            ...
            <td class="td-team">
              <div class="team-row">
                <div
                  class="team-badge"
                  :style="getTeamLogo(row.squadre) ? {} : { background: getTeamColor(row.squadre) }"
                >
                  <img v-if="getTeamLogo(row.squadre)" :src="getTeamLogo(row.squadre)" class="badge-img" />
                  <span v-else>{{ getInitials(row.squadre) }}</span>
                </div>
